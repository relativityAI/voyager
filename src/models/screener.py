...
class ScreenerResponse(BaseModel):
    ...
    annual_operating_profit: Optional[float] = Field(None, alias="Annual Operating Profit")
    ...
    annual_profit_before_tax: Optional[float] = Field(None, alias="Annual Profit before tax")
    ...
    annual_dividend_payout: Optional[float] = Field(None, alias="Annual Dividend Payout")

    # Balance Sheet
    balance_sheet_equity_capital: Optional[float] = Field(None, alias="Balance Sheet Equity Capital")
    balance_sheet_reserves: Optional[float] = Field(None, alias="Balance Sheet Reserves")
    balance_sheet_borrowings: Optional[float] = Field(None, alias="Balance Sheet Borrowings")
    balance_sheet_other_liabilities: Optional[float] = Field(None, alias="Balance Sheet Other Liabilities")
    balance_sheet_total_liabilities: Optional[float] = Field(None, alias="Balance Sheet Total Liabilities")
    balance_sheet_fixed_assets: Optional[float] = Field(None, alias="Balance Sheet Fixed Assets")
    balance_sheet_cwip: Optional[float] = Field(None, alias="Balance Sheet CWIP")
    balance_sheet_investments: Optional[float] = Field(None, alias="Balance Sheet Investments")
    balance_sheet_other_assets: Optional[float] = Field(None, alias="Balance Sheet Other Assets")
    balance_sheet_total_assets: Optional[float] = Field(None, alias="Balance Sheet Total Assets")

    # Cash Flow
    cash_flow_operating_activity: Optional[float] = Field(None, alias="Cash Flow Cash from Operating Activity")
    cash_flow_investing_activity: Optional[float] = Field(None, alias="Cash Flow Cash from Investing Activity")
    cash_flow_financing_activity: Optional[float] = Field(None, alias="Cash Flow Cash from Financing Activity")
    ...
    # Shareholding
    quarterly_holding_promoters: Optional[float] = Field(None, alias="Quarterly Shareholding Promoters")
    quarterly_holding_fiis: Optional[float] = Field(None, alias="Quarterly Shareholding FIIs")
    quarterly_holding_diis: Optional[float] = Field(None, alias="Quarterly Shareholding DIIs")
    quarterly_holding_public: Optional[float] = Field(None, alias="Quarterly Shareholding Public")
    quarterly_holding_no_shareholders: Optional[float] = Field(None, alias="Quarterly Shareholding No. of Shareholders")

    annual_holding_promoters: Optional[float] = Field(None, alias="Annual Shareholding Promoters")
    ...
    annual_holding_public: Optional[float] = Field(None, alias="Annual Shareholding Public")
    annual_holding_no_shareholders: Optional[float] = Field(None, alias="Annual Shareholding No. of Shareholders")

    # Growth Metrics
    sales_growth_10yrs: Optional[float] = Field(None, alias="Compounded Sales Growth 10 Years")
    sales_growth_5yrs: Optional[float] = Field(None, alias="Compounded Sales Growth 5 Years")
    sales_growth_3yrs: Optional[float] = Field(None, alias="Compounded Sales Growth 3 Years")
    sales_growth_ttm: Optional[float] = Field(None, alias="Compounded Sales Growth TTM")

    profit_growth_10yrs: Optional[float] = Field(None, alias="Compounded Profit Growth 10 Years")
    profit_growth_5yrs: Optional[float] = Field(None, alias="Compounded Profit Growth 5 Years")
    profit_growth_3yrs: Optional[float] = Field(None, alias="Compounded Profit Growth 3 Years")
    profit_growth_ttm: Optional[float] = Field(None, alias="Compounded Profit Growth TTM")
