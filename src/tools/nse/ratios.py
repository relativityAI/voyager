...
FINANCIAL_FIELDS: List[FinancialField] = [
    ...
    {
        "id": "CashFlowsFromUsedInInvestingActivities",
    ...
    },
    {
        ...
        "name": "Purchase of Non-current Assets (CapEx)",
        "type": "currency",
        "category": "cash_flow",
    },
    {
        "id": "PurchaseOfPropertyPlantAndEquipmentClassifiedAsInvestingActivities",
        "name": "Purchase of PP&E (CapEx)",
        "type": "currency",
        "category": "cash_flow",
        "field": "payments_for_purchase_of_noncurrent_assets",
    },
    {
        "id": "PurchaseOfOtherLongTermAssetsClassifiedAsInvestingActivities",
        "name": "Purchase of Other Long-term Assets (CapEx)",
        "type": "currency",
        "category": "cash_flow",
        "field": "payments_for_purchase_of_noncurrent_assets",
    },
    {
        "id": "PurchaseOfInvestmentPropertyClassifiedAsInvestingActivities",
        "name": "Purchase of Investment Property (CapEx)",
        "type": "currency",
        "category": "cash_flow",
        "field": "payments_for_purchase_of_noncurrent_assets",
    },
    {
        "id": "PurchaseOfIntangibleAssetsClassifiedAsInvestingActivities",
        "name": "Purchase of Intangible Assets (CapEx)",
        "type": "currency",
        "category": "cash_flow",
        "field": "payments_for_purchase_of_noncurrent_assets",
    },
    {
        "id": "PurchaseOfIntangibleAssetsUnderDevelopment",
        "name": "Purchase of Intangible Assets Under Development (CapEx)",
        "type": "currency",
        "category": "cash_flow",
        "field": "payments_for_purchase_of_noncurrent_assets",
    },
